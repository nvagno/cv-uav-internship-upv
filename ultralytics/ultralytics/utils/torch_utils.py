...
def strip_optimizer(f: str | Path = "best-model.pt", s: str = "", updates: dict[str, Any] | None = None) -> dict[str, Any]:
    ...
    def __call__(self, epoch, fitness):
        ...
        if stop:
            ...
            LOGGER.info(
                ...
                f"Best results observed at epoch {self.best_epoch}, best model saved as best-model.pt.\n"
