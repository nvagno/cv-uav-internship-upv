...
class RF100Benchmark:
    """Benchmark YOLO model performance on the RF100 datasets collection.
    ...
    def parse_dataset(self, ds_link_txt: str = "datasets_links.txt"):
        ...
        Returns:
            (tuple[list[str], list[Path]]): List of datasets names and list of paths to datasets configuration files.
