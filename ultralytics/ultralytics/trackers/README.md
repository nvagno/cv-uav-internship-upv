...
# model = YOLO("path/to/best-model.pt")  # Load a custom trained model
...
# yolo track model=path/to/best-model.pt source="https://youtu.be/LNwODJXcvt4" # Custom trained model

# Track using ByteTrack tracker
# yolo track model=path/to/best-model.pt tracker="bytetrack.yaml"
```
