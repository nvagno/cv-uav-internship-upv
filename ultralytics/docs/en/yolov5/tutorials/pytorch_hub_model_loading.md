...
model = torch.hub.load("ultralytics/yolov5", "custom", path="path/to/best-model.pt")  # local model
model = torch.hub.load("path/to/yolov5", "custom", path="path/to/best-model.pt", source="local")  # local repo
```
